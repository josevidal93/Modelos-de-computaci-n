...
public class parallelBelZabGraphic
{
	private static paralellBelZab reaccion;
	...
	public parallelBelZabGraphic()
	{
		//Create and set up the window.
		frame = new JFrame("Belousov-Zhabotinsky");
		...
		ejecutar.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				reaccion = new paralellBelZab(campoTam, campoAlfa, campoBeta, campoGamma);
				if (picLabel == null)
				{
	...
	{
		parallelBelZabGraphic x = new parallelBelZabGraphic();
	}
