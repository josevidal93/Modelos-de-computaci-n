...
public class ca1DGraphicSimulation  {
	...
	public ca1DGraphicSimulation() {
		...
		parametros.add(h,BorderLayout.WEST);
		parametros.add(entropia1,BorderLayout.WEST);		
		parametros.add(entropia2,BorderLayout.WEST);		
		parametros.add(cifrar,BorderLayout.WEST);
